...
venue: "Empirical Methods in Natural Language Processing (<strong>EMNLP</strong>)<br>ECCV Workshop on Medical Foundation Models and Benchmarks (<strong><span style='color:red;font-style:normal;'>Oral</span></strong>)<br>ECCV X-Reason Workshop (<strong><span style='color:red;font-style:normal;'>Oral</span></strong>)"
