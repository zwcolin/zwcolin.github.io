...
venue: "ICLR Workshop on Efficient Spatial Reasoning (<strong><span style='color:red;font-style:normal;'>Oral</span></strong>)<br>ICLR Workshop on Multimodal Intelligence (<strong><span style='color:red;font-style:normal;'>Best Paper Award, top 1.2%</span></strong>)"
